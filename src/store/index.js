...
if (typeof window !== 'undefined') {
	ssrCompose = compose(applyMiddleware(thunk.withExtraArgument({ getFirebase, getFirestore })), reduxFirestore(firebase.firestore()), reactReduxFirebase(firebase), hasDevToolsExtension());
}
